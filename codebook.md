...
1L)), class = "data.frame", row.names = c(NA, -9L)), vnam = "tGravityAcc_std_X")
```
...
0L, 1L)), class = "data.frame", row.names = c(NA, -10L)), vnam = "tBodyAccJerk_mean_X")
```
...
-11L)), vnam = "tBodyGyroJerkMag_mean")
```
...
-8L)), vnam = "fBodyBodyAccJerkMag_mean")
```
...
-13L)), vnam = "fBodyBodyGyroMag_mean")
```
...
-12L)), vnam = "fBodyBodyGyroJerkMag_mean")
```
 ...
 *  Created by: Pia Schneider (username: `pia.schneider.2012`).

 *  Report creation time: Sa Okt 24 2020 17:48:04

 *  Report was run from directory: `D:/Dokumente/R-Kurs/Week4-Project/UCI HAR Dataset`
 ...
 *  Function call: `dataMaid::makeDataReport(data = agg_data, mode = c("summarize", 
"visualize", "check"), smartNum = FALSE, file = "codebook_agg_data.Rmd", 
    ...
    listChecks = FALSE, maxProbVals = Inf, codebook = TRUE, reportTitle = "Codebook for agg_data")`
